...
<div class="regbox"><?php if(isset($_GET["errMsg"]) && ($_GET["errMsg"]=="1"))?>
          ...
          <hr size="1" />
          <align="left"><a href="admin_passmail.php">忘記密碼</a>
          <align="right"><a href="member_join.php">註冊帳號</a>
</div>
